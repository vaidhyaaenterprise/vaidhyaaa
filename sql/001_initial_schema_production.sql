...
CREATE UNIQUE INDEX patients_unique_phone_name
ON patients (clinic_id, normalized_phone, normalized_name)
WHERE normalized_phone IS NOT NULL AND normalized_name IS NOT NULL;
